        ...
        body: SpinCircleBottomBarHolder(
          ...
          child: Column(
            ...
            children: [
              ...
              //   child: Text('Welcome $name ! to the application '
              //       ', to start click on the + button in the bottom of the screen and choose your type of getting the image then it will be displayed right after you select'.toUpperCase()),
              // ),
              Column(
                children: [
                  if (_image != null)
